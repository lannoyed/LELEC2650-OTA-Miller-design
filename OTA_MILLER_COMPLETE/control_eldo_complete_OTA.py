...
def modification(line, File_new, Cf, Cf2, CL, W, L, VIN, IBIAS):
    
    
    if line.split('=')[0].strip(' ') == '.param Cl':
        File_new.write('.param Cl = {}p\n'.format(CL))
    elif line.split('=')[0].strip(' ') == '.param Cf':
        File_new.write('.param Cf = {}p\n'.format(Cf))
    elif line.split('=')[0].strip(' ') == '.param Cf2':
        File_new.write('.param Cf2 = {}p\n'.format(Cf2))
    ...
    elif line.split('=')[0] == '.param W10 ':
        File_new.write('.param W10 = {}u\n'.format(W[8]))
    elif line.split('=')[0] == '.param L10 ':
        File_new.write('.param L10 = {}u\n'.format(L[8]))
    elif line.split('=')[0] == '.param W11 ':
        File_new.write('.param W11 = {}u\n'.format(W[9]))
    elif line.split('=')[0] == '.param L11 ':
        File_new.write('.param L11 = {}u\n'.format(L[9]))
    elif line.split('=')[0] == '.param W12 ':
        File_new.write('.param W12 = {}u\n'.format(W[10]))
    elif line.split('=')[0] == '.param L12 ':
        File_new.write('.param L12 = {}u\n'.format(L[10]))
    elif line.split('=')[0] == '.param W13 ':
        File_new.write('.param W13 = {}u\n'.format(W[11]))
    elif line.split('=')[0] == '.param L13 ':
        File_new.write('.param L13 = {}u\n'.format(L[11]))
    elif line.split('=')[0] == '.param W14 ':
        File_new.write('.param W14 = {}u\n'.format(W[12]))
    elif line.split('=')[0] == '.param L14 ':
        File_new.write('.param L14 = {}u\n'.format(L[12]))
    elif line.split('=')[0] == '.param W14 ':
        File_new.write('.param W14 = {}u\n'.format(W[13]))
    elif line.split('=')[0] == '.param L14 ':
        File_new.write('.param L14 = {}u\n'.format(L[13]))
    elif line.split('=')[0] == '.param W15 ':
        File_new.write('.param W15 = {}u\n'.format(W[14]))
    elif line.split('=')[0] == '.param L15 ':
        File_new.write('.param L15 = {}u\n'.format(L[14]))
    elif line.split('=')[0] == '.param W16 ': 
        File_new.write('.param W16 = {}u\n'.format(W[15]))
    elif line.split('=')[0] == '.param L16 ': 
        File_new.write('.param L16 = {}u\n'.format(L[15]))
    elif line.split('=')[0] == '.param W17 ': 
        File_new.write('.param W17 = {}u\n'.format(W[16]))
    elif line.split('=')[0] == '.param L17 ':   
        File_new.write('.param L17 = {}u\n'.format(L[16]))
                ...
                for gmid6 in gmid6_list: 
                    for gmid7 in gmid7_list: 
                        for gmid8 in gmid8_list: 
                            ...
                            #attention odre des outputs
                            Cf_result, Cf2_result, CL_result, W_list, L_list, IBIAS, VIN, vdsat_list = Miller_sizing.Miller_sizing(Cf, fT, CL, L, gmid1, gmid3, gmid5, gmid6, gmid7, gmid8)  
                            ...
                            if safe_solution(W_list, VIN, IBIAS):
                                ...
                                with codecs.open('Miller_OTA_Basic.cir', 'r', encoding=encoding) as File:
                                    with codecs.open('to_test.cir', 'w', encoding=encoding) as File_new:
                                        for line in File:
                                            modification(line, File_new, Cf_result, Cf2_result, CL_result, W_list, L_list, VIN, IBIAS)
